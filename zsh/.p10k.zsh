# Generated by Powerlevel10k configuration wizard on 2020-03-15 at 17:08 +08.
...
# vertical separators, round heads, round tails, 2 lines, solid, no frame,
...
() {
  ...
  function my_git_formatter() {
    ...
    # Uncomment to enable the truncation
